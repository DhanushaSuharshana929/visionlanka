        ...
        <div  class="main">
            ...
            <section class="welcome-section   " >
                <div class="container-fluid">
                    <div  class="row">
                        <div class="col-md-6 col-sm-12 col-xs-12 mg-top-50">
                        ...
                        <div class="col-md-6 w-bg hidden-sm hidden-xs" >
                            <a href="https://www.tripadvisor.com/Attraction_Review-g297896-d5897194-Reviews-Vision_Lanka_Tours_Private_Day_Tours-Galle_Galle_District_Southern_Province.html" target="new">
                            <div class="col-md-10">
                                <div class="col-md-5"></div>
                                <div class="col-md-7 r-left" > 
                                    <div class="col-md-12" >
                                                    ...
                                                    foreach ($COMMENT as $key => $comments) {
                                                        if ($key === 0) {
                                                            ...
                                                            <div class="item active">
                                                                <div class="testimonial mg-top-20">
                                                                    <div class="description">
                                                                        "<?php echo substr($comments["comment"], 0, 200) . '....'; ?>"
                                                                    </div>
                                                                    <h3 class="title"> <?php echo $comments["name"]; ?></h3>
                                                                    <div class="pic">
                        ...
                        <div class="hidden-lg hidden-md  col-sm-12 col-xs-12 " >
                                ...
                                <div class="col-xs-12 col-sm-12 tp-pic">
                                    <img src="images/about-srilanka/tp.png" alt=""/>
                                </div>
                    ...
                    <div class="row">
                        <div class="col-xs-12 col-sm-12 col-md-8 col-lg-8 card-pd">
                            ...
                            <figure>
                                ...
                                <p class="as-content">Sri Lanka is Tropical Island to fill cultural and natural treasures in the Indian Ocean which has remarkable combination of stunning landscapes, pristine beaches, captivating cultural heritage, UNESCO World Heritage Sites, national parks showcasing an abundance of wildlife , botanical gardens, waterfalls , water bodies ……..</p>
                               </a>
                            </figure>
                        ...
                        <div class="col-xs-6 col-sm-6 col-md-4 col-lg-4 card-pd">
                            <figure>
                                ...
                                <p class="as-content">Round Tours will cover a variety of attractions such as Cultural and Heritage, Wild Life, Beach, Adventure, and scenic sites ,……….</p>
                                  </a>
                            </figure>
                        </div>
                        ...
                        <div class="col-xs-6 col-md-4 col-lg-4 col-sm-6 card-pd">
                            <figure>
                                ...
                                <p class="as-content">Places to visit in Sri Lanka within one day during your short vacation. Here is the list of places to visit in Galle Fort, Unawatuna , Hikkaduwa,….</p>
                                </a>
                            </figure>
                        </div>
                        ...
                        <div class="col-xs-6 col-md-4 col-lg-4 col-sm-6 card-pd">
                            <figure>
                                ...
                                <p class="as-content">Sri Lanaka is the most rare and the most extensive range of attractions like beaches, wildlife covered mountains draped with carpets of tea, ……….</p>
                                </a>
                            </figure>
                        </div>
                        ...
                        <div class="col-xs-6 col-md-4 card-pd">
                            <figure>
                                ...
                                <p class="as-content">Discover the best Fun and thrilling things to do in Sri Lanka like as Bird watching, Wildlife safari, Surfing, Scuba diving, honeymoon, Hiking, trekking, …….</p>
                                </a>
                            </figure>
                        </div>
                                ...
                                foreach ($GALLERY as $key => $photo) {
                                    ...
                                    <div class="item col-md-12 col-sm-4 g-pd">
                                        ...
                                        <div class="gallery-thumb th-bg">
                                            <figure>
                                                <img src="./upload/photo-album/gallery/thumb/<?php echo $photo["image_name"]; ?>" alt="<?php echo $photo["title"]; ?>"/>
                                            </figure>
                                        </div>
                                        <!-- GALLERY THUMB END -->
                                    </div>
