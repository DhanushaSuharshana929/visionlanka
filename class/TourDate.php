...
class TourDate {
    ...
    public function __construct($id) {
        if ($id) {
            ...
            $query = "SELECT `id`,`tour`,`title`,`image_name`,`summery`,`short_description`,`description`,`inclusion`,`queue` FROM `tour_date` WHERE `id`=" . $id;
            ...
            $this->summery = $result['summery'];
            $this->short_description = $result['short_description'];
            $this->description = $result['description'];
            $this->inclusion = $result['inclusion'];
    ...
    public function create() {
        ...
        $query = "INSERT INTO `tour_date` (`tour`,`title`,`image_name`,`summery`,`short_description`,`description`,`inclusion`,`queue`) VALUES  ('"
                . $this->tour . "','"
                . $this->title . "','"
                . $this->image_name . "', '"
                . $this->summery . "', '"
