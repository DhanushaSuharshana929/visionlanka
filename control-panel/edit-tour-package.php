                            ...
                            <div class="body">
                                <form class="form-horizontal" method="post" action="post-and-get/tour-package.php" enctype="multipart/form-data"> 
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group form-float">
                                            <div class="form-line">
                                                <input type="text" id="sub_title" class="form-control"  value="<?php echo $TOUR_PACKAGE->sub_title; ?>"  name="sub_title"  required="TRUE">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group form-float">
                                            <div class="form-line">
                                                <input type="text" id="day" class="form-control"  value="<?php echo $TOUR_PACKAGE->day; ?>"  name="day"  required="TRUE">
                                    ...
                                    <div class="col-sm-12">
                                        <div class="form-group form-float">
                                            <div class="form-line">
                                                <input type="text" id="highlights" class="form-control" value="<?php echo $TOUR_PACKAGE->highlights; ?>"  name="highlights">
                                                <label class="form-label">Programme Details</label>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-12">                                       
                                    ...
                                    <div class="col-md-12">                                       
                                        <div class="form-group form-float">
                                            <div class="form-line">
                                                <input type="file" id="sub_image" class="form-control" value="<?php echo $TOUR_PACKAGE->sub_image; ?>"  name="sub_image">
                                                <img width="20%" src="../upload/tour-package/sub-image/<?php echo $TOUR_PACKAGE->sub_image; ?>" id="sub_image" class="img img-responsive img-thumbnail" name="sub_image" alt="old image">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                     ...
                                     <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 ">
                                        <label for="highlights">Inclusions</label>
                                        <div class="form-line">
                                            <textarea id="description" name="short_description" class="form-control long-text" rows="5"><?php echo $TOUR_PACKAGE->short_description; ?></textarea> 
                                        </div>
                                    </div>

                                    <div class="col-md-12">
                                        <input type="hidden" id="oldImageName" value="<?php echo $TOUR_PACKAGE->image_name; ?>" name="oldImageName"/>
                                        <input type="hidden" id="oldSubImageName" value="<?php echo $TOUR_PACKAGE->sub_image; ?>" name="oldSubImageName"/>
