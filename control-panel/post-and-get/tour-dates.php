...
if (isset($_POST['create'])) {
    ...
    $TOUR_DATE->summery = $_POST['summery'];
    $TOUR_DATE->short_description = $_POST['short_description'];
    $TOUR_DATE->description = $_POST['description'];
    $TOUR_DATE->inclusion = $_POST['inclusion'];
...
if (isset($_POST['update'])) {
    ...
    $TOUR_DATE->summery = filter_input(INPUT_POST, 'summery');
    $TOUR_DATE->short_description = filter_input(INPUT_POST, 'short_description');
    $TOUR_DATE->description = filter_input(INPUT_POST, 'description');
    $TOUR_DATE->inclusion = filter_input(INPUT_POST, 'inclusion');
