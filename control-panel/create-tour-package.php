                            ...
                            <div class="body">
                                <form class="form-horizontal"  method="post" action="post-and-get/tour-package.php" enctype="multipart/form-data"> 
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group form-float">
                                            <div class="form-line">
                                                <input type="text" id="sub_title" class="form-control"  autocomplete="off" name="sub_title" required="true">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group form-float">
                                            <div class="form-line">
                                                <input type="text" id="day" class="form-control" autocomplete="off" name="day" required="true">
                                    ...
                                    <div class="col-md-12">                                       
                                        <div class="form-group form-float">
                                            <div class="form-line">
                                                <input type="file" id="sub_image" class="form-control" name="sub_image"  required="true">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 ">
                                        <label for="highlights">Programme Details</label>
                                        <div class="form-line">
