                                ...
                                <form class="form-horizontal" method="post" action="post-and-get/tour-dates.php" enctype="multipart/form-data"> 
                                    ...
                                    <div class="col-md-12">                                       
                                       ...
                                       <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                        ...
                                        <div class="form-line">
                                            <textarea id="summery" name="summery" class="form-control long-text" rows="5"><?php echo $TOUR_DATE->summery; ?></textarea> 
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                        ...
                                        <div class="form-line">
                                            <textarea id="description" name="description" class="form-control long-text" rows="5"><?php echo $TOUR_DATE->description; ?></textarea> 
                                        </div>
                                    </div>
                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 hidden">
                                        <label for="description">Inclusions and Exclusions</label>
                                        <div class="form-line">
                                            <input type="text" id="inclusion" name="inclusion" class="form-control long-text" value="-">
                                        </div>
                                    </div>
