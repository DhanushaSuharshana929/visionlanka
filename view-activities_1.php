                                ...
                                if ($key < 5) {
                                    ...
                                    <div class="col-md-12 more-item">
                                        <a href="view-activities.php?id=<?php echo $more_activity["id"]; ?>">
                                            <div class="col-md-5">
                                                <img src="./upload/activity/<?php echo $more_activity["image_name"]; ?>" alt="<?php echo $more_activity["title"]; ?>"/>
                                            </div>
                                            <div class="col-md-7">
                                                <?php
                                                $letters = strlen($more_activity["title"]);
                                                if ($letters > 20) {
                                                    ?>
                                                    <h4><?php echo substr($more_activity["title"], 0, 12) . '....'; ?></h4>
                                                    <p><small><?php echo substr($more_activity["description"], 0, 55) . '...'; ?></small></p>
                                                    <?php
                                                } else {
                                                    ?>
                                                    <h4><?php echo $more_activity["title"]; ?></h4>
                                                    <p><small><?php echo substr($more_activity["description"], 0, 55) . '...'; ?></small></p>
                                                    <?php
                                                }
                                                ?>
