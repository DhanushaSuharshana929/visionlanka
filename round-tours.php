...
$ROUNDTOURS_OBJ = new TourPackage(null);
?>
<!DOCTYPE html>
<html lang="en">
    <head>
        <meta charset="UTF-8">
        <title>Round Tours | Vision Lanka Tours</title> 
        ...
        <div  class="main">
            ...
            <div class="sub-banner  mg-bottom-50 about-bottom-30" style="background-image: url('./images/parallex.jpg') ">
                <ol class="breadcrumb">
                    ...
                    <li>/</li>
                    <li class="breadcrumb-item active">Round Tours</li>
                </ol>
            </div>

            <section class="full-row   mg-bottom-50 ">
                <div class="container-fluid">
                    <div class="row">
                        <div class="awesome-place-item-box">
                            <?php
                            $ROUNDTOURS = $ROUNDTOURS_OBJ->selectRoundTours();
                            foreach ($ROUNDTOURS as $key => $roundtours) {
                                ?>
                                <a href="view-package.php?id=<?php echo $roundtours["id"]; ?>" class="text-white">        
                                    <div class="col-lg-3 col-md-3 col-xs-12 col-sm-6 p-left">

                                        <div class="awesome-place-item overlay-5 hover_zoom mb-30"> 
                                            <div class="overflow_hidden"><img src="./upload/tour-package/<?php echo $roundtours["image_name"]; ?>" alt="<?php echo $roundtours["title"]; ?>"></div>
                                            <div class="upper-place-bottom-left text-white">
                                                <h4 class="fw-5 text-white"><?php echo $roundtours["title"]; ?></h4>
                                                <h5 class="fw-5 text-white"><?php echo $roundtours["day"]; ?></h5>
