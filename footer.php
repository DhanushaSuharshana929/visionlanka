        ...
        <div class="row">
            ...
            <div class="col-md-4">
                <ul  class=" footer-contact">
                    ...
                    <li><i class="fa fa-phone"></i><a href="tel:0094 777 85 59 85">0094 777 85 59 85</a></li>
                    <li><i class="fa fa-map"></i><a href="#">Eramudugaha Junction, Unawatuna </a> </li>
                    <li><i class="fa fa-clock-o"></i><a href="#">Opening Mon to Fri 8:00am to 10:00pm</a></li>
                </ul>
            </div>
...
<!-- Global site tag (gtag.js) - Google Analytics --> <script async src="https://www.googletagmanager.com/gtag/js?id=UA-103053993-5"> </script> <script> window.dataLayer = window.dataLayer || []; function gtag(){dataLayer.push(arguments);} gtag('js', new Date()); gtag('config', 'UA-103053993-5'); </script>