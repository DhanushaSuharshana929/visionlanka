...
<html lang="en">
    ...
    <body>
     ...
     <div class="preloader"></div>
            ...
            <div class="section mg-bottom-50 mg-top-80">
                <div class="container">
                    <div class="row">
                        <div class="col-md-10 col-lg-10">
                                    ...
                                    <div class="" style="margin-top: 25px">
                                        <div class="accordion-content-2">
                                            <!-- Tour Tips Thumb Start -->
                                                ...
                                                <div class="col-md-6">
                                                    <div class="thinn-tour-tips text text-tour-2">
                            ...
                            <div ><center> <a href="contact.php">
                                      <button type="submit"  id="btnSubmit" class="btn-button btn-1 btn-1e">Contact Us</button> 
                        ...
                        <div class="col-md-2 it-br hidden-xs hidden-sm">
                                    ...
                                    <div class="col-md-12 more-item  ">
                                        <a href="view-package.php?id=<?php echo $more_package["id"]; ?>">
                                            <div class="col-md-12">
                                                ...
                                                <h3 ><?php echo $more_package["title"]; ?></h3>
                                            </div>
                        ...
                        <div class="col-md-2 it-br hidden-lg hidden-md">
                            <div class="col-md-12">
