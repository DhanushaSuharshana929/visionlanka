...
$ACTIVITY_OBJ = new Activities($id);
$ACTIVITY_PHOTOS_OBJ = new ActivitiesPhoto(null);
?>
<!DOCTYPE html>
<html lang="en">
    <head>
        <meta charset="UTF-8">
        <title>Activity | Vision Lanka Tours</title> 
        ...
        <div  class="main">
            ...
            <div class="sub-banner  mg-bottom-50 about-bottom-50" style="background-image: url('./images/parallex.jpg') ">
                <ol class="breadcrumb">
                    ...
                    <li>/</li>
                    <li class="breadcrumb-item "><a href="activity.php">Activities</a></li>
                    <li>/</li>
                    <li class="breadcrumb-item active"><?php echo $ACTIVITY_OBJ->title; ?></li>
                </ol>
                <a href="view-activities.php"></a>
            </div>
                        ...
                        <div class="col-md-9 col-lg-9 col-sm-12 col-xs-12">
                            ...
                            <div id="view-attraction" class="carousel slide" data-ride="carousel">
                                ...
                                <div class="carousel-inner">
                                    ...
                                    <?php
                                    $ACTIVITY_PHOTOS = $ACTIVITY_PHOTOS_OBJ->getActivitiesPhotosById($id);
                                    foreach ($ACTIVITY_PHOTOS as $key => $photos) {
                                        if ($key < 3) {
                                        ...
                                        if ($key === 1) {
                                            ...
                                            <div class="item active">
                                                <img src="./upload/activity/gallery/<?php echo $photos["image_name"]; ?>" alt="<?php echo $photos["title"]; ?>" >
                                            </div>
                            ...
                            <div class="entry-body">
                                <h3><?php echo $ACTIVITY_OBJ->title; ?>   </h3>
                                <?php echo $ACTIVITY_OBJ->description; ?>  
                            </div>
                        ...
                        <div class="it-br col-md-3 col-lg-3 col-sm-12 col-xs-12">
                            <div class="hidden-sm hidden-xs">
                                <div class="more-title text-center">
                                    ...
                                    <?php
                                    $MORE_ACTIVITY = $ACTIVITY_OBJ->all();
                                    foreach ($MORE_ACTIVITY as $key => $more_activity) {
                                        if ($key < 7) {
                                            ?>
                                            <div class="col-md-12 more-item1">
                                                <a href="view-activities.php?id=<?php echo $more_activity["id"]; ?>">
                                                    <div class="col-md-5">
                                                        <img class="view-side-img" src="./upload/activity/<?php echo $more_activity["image_name"]; ?>" alt="<?php echo $more_activity["title"]; ?>"/>
                                                    </div>
                                                    <div class="col-md-7">
                                                        <h4 class="more-side-title"><?php echo $more_activity["title"]; ?></h4>
                                    ...
                                    <div class="sidebar widget popular-categories wow fadeInUp animated" data-wow-delay="0ms" data-wow-duration="1500ms" style="visibility: visible; animation-duration: 1500ms; animation-delay: 0ms; animation-name: fadeInUp;padding-top: 20px;">
                                        ...
                                        <div class="sidebar-widget category-posts">
                                            <div class="main-title-2">
                                                <div class="sidebar-title"> <h3>More Activities</h3></div>
                                            </div>
                                            <ul class="list-unstyled list-cat">
                                                ...
                                                foreach ($MORE_ACTIVITY as $key => $more_activity) {
                                                    ...
                                                    <li><a href="view-activities.php?id=<?php echo $more_activity["id"]; ?>"><?php echo $more_activity["title"]; ?></a></li>
                                                    <?php
                                                }
                                                ?>
                                            </ul>
