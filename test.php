            ...
            <header class="header-main">
                <div class="container no-padding">		
                    ...
                    <div class="header-contact-info">			
                        ...
                        <!-- Header Socials -->
                        <div class="col-md-3 col-sm-12 col-xs-12 header-socials">
                            <ul class="no-padding">
                            ...
                            <a href="contact.php" class="contact-us">Inquire Now</a>
                        </div><!-- / Header Socials -->
                ...
                <div id="photos-slider" class="carousel slide carousel-fade col-offset-2" data-ride="carousel">
                    ...
                    <div class="carousel-inner" role="listbox">
                        <div class="item active">
                            <img src="upload/slider/-112015720_191091125186_1555994974_n.jpg" alt="sider-1"/>
                        </div>
                        <div class="item">
                            <img src="upload/slider/-165381625_191037759281_1554878311_n.jpg" alt="sider-2"/>
                        </div>
                        <div class="item">
                            <img src="upload/slider/-440084360_190763056546_1554878291_n.jpg" alt="sider-1"/>
                        </div>
                        <div class="item">
                            <img src="upload/slider/-83042421_191120098485_1555996569_n.jpg" alt="sider-2"/>
                        </div>
                    </div>
                    <!-- Photos Slider Note -->
                    <div class="container photos-slider-note">				
                        <!-- Controls -->
                ...
                <div class="container">
                    <div  class="row">
                        <div class="col-md-12 col-sm-12 col-xs-12 mg-top-50">
                            ...
                            <div class="col-md-8 col-xs-12 col-sm-12 welcome-res">
                                <div class="main-title text-left title-res">
