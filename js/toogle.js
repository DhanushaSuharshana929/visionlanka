!function (e) {
    ...
    if (e(".site-backtop").on("click", function (t) {
        ...
        e("input.datepicker").datepicker(),
                e("body").append("<style>.ui-datepicker{width:auto; min-width: " + r + "px !important;}</style>")
    }
    if (e(".video-full").length && e(".video-full").fitVids(), e(".widget-slider").length && e(".widget-slider .widget-carousel").owlCarousel({
        items: 1, nav: true, autoplay: true, loop: true, navText: ["", ""], dots: !0, autoHeight: !0, animateOut: "fadeOut", animateIn: "fadeIn", onInitialized: function () {
